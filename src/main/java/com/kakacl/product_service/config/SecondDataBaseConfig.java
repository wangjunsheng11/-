...
@MapperScan(basePackages = SecondDataBaseConfig.PACKAGE, sqlSessionFactoryRef = "secondSqlSessionFactory")
...
public class SecondDataBaseConfig {
     ...
     * dao层的包路径
     */
    static final String PACKAGE = "com.kakacl.product_service.mappers";

    /**
     * mapper文件的相对路径
     */
    private static final String MAPPER_LOCATION = "classpath:secondmappers/*.xml";
    ...
    public static String getPACKAGE() {return PACKAGE;}

    public static String getMapperLocation() { return MAPPER_LOCATION;}
    ...
    public SqlSessionFactory backSqlSessionFactory(@Qualifier("secondDataSource") DataSource backDataSource) throws Exception {
        final SqlSessionFactoryBean sessionFactory = new SqlSessionFactoryBean();
        sessionFactory.setDataSource(backDataSource);
        sessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources(SecondDataBaseConfig.MAPPER_LOCATION));
